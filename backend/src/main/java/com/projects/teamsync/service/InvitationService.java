...
public class InvitationService {
        ...
        public InvitationService(
                        ...
                        NotificationService notificationService,ApplicationRepository applicationRepository) {
        ...
        public ApiResponse sendInvitation(
                ...
                Student creator = getAuthenticatedStudent();
                ...
                Student invited = studentRepository
                                .findById(
                ...
                if (count >= project.getDesiredTeamSize()) {
                ...
                boolean alreadyApplied=applicationRepository.existsByStudentAndProject(invited, project);
                if(alreadyApplied){
                        throw new ConflictException(
        ...
        public List<InvitationResponse> getMyInvitations() {
                ...
                List<InvitationResponse> invites = new ArrayList<>();

                for (Invitation invitation : invitations) {

                        InvitationResponse invited = new InvitationResponse();
                        ...
                        invited.setProjectName(
                                        ...
                                        invitation.getProject()
                                                        .getName());
                        invited.setSentToStudentId(
                                        invitation.getSentTo().getId());

                        invited.setSentToUserName(
                                        invitation.getSentTo().getUserName());
                        ...
                        for (ProjectSkill projSkill : projectSkills) {
...
public List<InvitationResponse> getProjectInvitations(
        Integer projectId) {
    ...
    // Only the project creator can view its invitations
    if (!project.getCreatedBy()
            .getId()
            .equals(creator.getId())) {

        throw new UnauthorizedException(
                "You are not authorized to view invitations for this project");
    }
    ...
    for (Invitation invitation : invitations) {
        ...
        response.setSentToStudentId(
                invitation.getSentTo().getId());

        response.setSentToUserName(
                invitation.getSentTo().getUserName());
        ...
        response.setProjectSkills(skills);
    ...
    return invites;
        ...
        public ApiResponse updateInvitationStatus(
                ...
                InvitationStatus status = request.getStatus();
                ...
                if (status == InvitationStatus.ACCEPTED) {
                        ...
                        long currentMembers = projectMemberRepository
                                        .countByProjectAndStatus(
                        ...
                        if (currentMembers >= project.getDesiredTeamSize()) {

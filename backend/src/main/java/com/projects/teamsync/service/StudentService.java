...
public class StudentService {
        ...
        public ApiResponse registerRequest(RegisterRequest registerRequest) {
                ...
                if (!isEmailExists) {
                        ...
                        student.setAvailability(Availability.AVAILABLE);
        ...
        public StudentProfileResponse viewProfile(
                ...
                List<StudentSkillResponse> skills = new ArrayList<>();
        ...
        public List<StudentSearchResponse> searchStudents(
                ...
                List<StudentSearchResponse> response = new ArrayList<>();

                for (Student student : students) {

                        StudentSearchResponse studentResponse = new StudentSearchResponse();
        ...
        public ApiResponse completeProfile() {
    ...
    return new ApiResponse(
        ...
        public StudentProfileResponse getMyProfile() {
                ...
                return viewProfile(student.getId());
        }
}